...
<body class="bg-slate-50 font-sans text-slate-900 antialiased">
    ...
    <div class="flex h-screen overflow-hidden bg-slate-50">
        ...
        <aside class="w-72 bg-slate-900 text-white flex-shrink-0 hidden lg:flex flex-col shadow-2xl">
            <div class="p-6 bg-slate-900 border-b border-slate-800">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-yellow-600 rounded-xl flex items-center justify-center shadow-lg shadow-yellow-500/20">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1 custom-scrollbar">
                ...
                <a href="<?= BASE_URL ?>dashboard" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group <?= ($title ?? '') === 'Dashboard' ? 'bg-yellow-600 text-white shadow-lg shadow-yellow-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>">
                ...
                <a href="<?= BASE_URL ?>menu" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group <?= ($title ?? '') === 'Manajemen Menu' ? 'bg-yellow-600 text-white shadow-lg shadow-yellow-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="24 24" stroke="currentColor">
                ...
                <a href="<?= BASE_URL ?>bahan" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group <?= (strpos($title ?? '', 'Bahan Baku') !== false) ? 'bg-yellow-600 text-white shadow-lg shadow-yellow-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="24 24" stroke="currentColor">
                ...
                <a href="<?= BASE_URL ?>produksi/rencana" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group <?= (strpos($title ?? '', 'Produksi') !== false && strpos($title ?? '', 'Laporan') === false) ? 'bg-yellow-600 text-white shadow-lg shadow-yellow-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="24 24" stroke="currentColor">
                ...
                <a href="<?= BASE_URL ?>laporan/produksi" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group <?= (strpos($title ?? '', 'Laporan') === 0) ? 'bg-yellow-600 text-white shadow-lg shadow-yellow-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="24 24" stroke="currentColor">
            ...
            <div class="p-4 bg-slate-900 border-t border-slate-800">
                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-800/50">
                    <div class="w-10 h-10 rounded-full bg-yellow-500 flex items-center justify-center font-bold text-white shadow-inner">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <!-- Navbar -->
            <header class="bg-white border-b border-slate-200 h-20 flex items-center justify-between px-8 sticky top-0 z-10 shadow-sm">
                ...
                <div class="flex items-center gap-6">
                    <div class="relative hidden md:block">
                        <input type="text" placeholder="Cari data..." class="w-64 bg-slate-50 border-none rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-yellow-500/20 transition-all">
                    </div>
            ...
            <!-- Content -->
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-slate-50 p-8 custom-scrollbar">
