...
<body class="bg-stone-50 dark:bg-stone-900 font-sans text-stone-900 dark:text-stone-100 antialiased transition-colors duration-300">
    ...
    <nav class="bg-white/80 dark:bg-stone-900/80 backdrop-blur-md sticky top-0 z-50 border-b border-stone-200 dark:border-white/5 transition-colors">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
                ...
                <?php else: ?>
                    <a href="<?= BASE_URL ?>auth/index" class="btn-primary flex items-center gap-2 !py-2 !px-3 md:!py-2.5 md:!px-6">
