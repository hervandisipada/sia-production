<div class="space-y-8 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500">Berikut adalah ringkasan aktivitas produksi Pawon Selaras hari ini.</p>
        </div>
        <div class="flex items-center gap-3">
            ...
            <div class="text-right">
                ...
                <p class="text-xs text-gray-500"><?= date('H:i') ?> WITA</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="group bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-medium text-brand-yellow bg-stone-50 px-2 py-1 rounded-full">Katalog</span>
            </div>
        ...
        <div class="group bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
                <div class="w-12 h-12 bg-stone-50 rounded-xl flex items-center justify-center text-brand-yellow group-hover:bg-brand-yellow group-hover:text-white transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                </div>
                <span class="text-xs font-medium text-brand-yellow bg-stone-50 px-2 py-1 rounded-full">Produksi</span>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="<?= BASE_URL ?>produksi/tambah" class="flex flex-col items-center p-4 rounded-xl border border-gray-50 hover:bg-stone-50 hover:border-yellow-100 transition-all group">
                    <div class="w-10 h-10 rounded-lg bg-yellow-100 flex items-center justify-center text-brand-yellow mb-2 group-hover:scale-110 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="24 24" stroke="currentColor">
