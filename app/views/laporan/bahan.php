<div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
        <div>
            <h1 class="text-2xl font-bold text-stone-800">Laporan Stok Bahan Baku</h1>
            <p class="text-stone-500 text-sm">Rekapitulasi persediaan dan estimasi nilai aset gudang.</p>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-stone-50/50">
                        <th class="px-6 py-4 text-xs font-bold text-stone-500 uppercase tracking-widest border-b border-stone-100">Nama Bahan</th>
                        <th class="px-6 py-4 text-xs font-bold text-stone-500 uppercase tracking-widest border-b border-stone-100 text-center">Stok Sistem</th>
                        <th class="px-6 py-4 text-xs font-bold text-stone-500 uppercase tracking-widest border-b border-stone-100">Satuan</th>
                        <th class="px-6 py-4 text-xs font-bold text-stone-500 uppercase tracking-widest border-b border-stone-100 text-center hidden print:table-cell border-l">Stok Fisik</th>
                        <th class="px-6 py-4 text-xs font-bold text-stone-500 uppercase tracking-widest border-b border-stone-100 text-right">Nilai Aset</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-stone-50">
                    ...
                    <tr class="hover:bg-stone-50/50 transition-colors">
                        <td class="px-6 py-4">
                            <p class="text-sm font-bold text-stone-800"><?= htmlspecialchars($row['nama']) ?></p>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <span class="inline-flex items-center justify-center min-w-[40px] px-2 py-1 bg-stone-100 rounded-lg text-sm font-black text-stone-700">
                                <?= htmlspecialchars($row['stok']) ?>
                            </span>
                        </td>
                        <td class="px-6 py-4 text-sm text-stone-500 font-medium"><?= htmlspecialchars($row['satuan']) ?></td>
