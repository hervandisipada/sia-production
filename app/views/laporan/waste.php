<div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Laporan Waste Produksi</h1>
            <p class="text-slate-500 text-sm">Analisis kehilangan produk dan kendala kualitas.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 print:hidden">
        <form action="<?= BASE_URL ?>laporan/waste" method="GET" class="flex flex-col md:flex-row items-end gap-6">
            ...
            <div class="space-y-2">
                <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Periode Laporan</label>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="hidden print:block p-8 text-center border-b-2 border-slate-100">
            ...
            <p class="text-slate-500 font-bold uppercase tracking-widest mt-1">Laporan Waste / Produk Rusak</p>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50">
                        <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-widest border-b border-slate-100">Tanggal Produksi</th>
                        <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-widest border-b border-slate-100">Item Menu</th>
                        <th class="px-6 py-4 text-xs font-bold text-rose-500 uppercase tracking-widest border-b border-slate-100 text-right">Jumlah Rusak (Waste)</th>
                    </tr>
                </thead>
        ...
        <?php if(empty($data)): ?>
        <div class="py-12 text-center text-slate-400 font-medium italic bg-white">
