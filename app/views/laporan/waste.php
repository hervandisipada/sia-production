<div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
        ...
        <div class="flex items-center gap-3">
            <a href="<?= BASE_URL ?>laporan/waste?dari=<?= htmlspecialchars($dari) ?>&sampai=<?= htmlspecialchars($sampai) ?>&export=csv" class="btn-secondary">
    ...
    <div class="bg-white dark:bg-stone-800 rounded-2xl shadow-sm border border-stone-100 dark:border-stone-700/50 p-6 print:hidden">
        <form action="<?= BASE_URL ?>laporan/waste" method="GET" class="flex flex-col md:flex-row items-end gap-6">
            ...
            <div class="w-full md:w-auto space-y-2">
                <label class="block text-xs font-bold text-stone-500 dark:text-stone-400 uppercase tracking-widest ml-1">Periode Laporan</label>
                <div class="flex items-center gap-3">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-stone-50/50 dark:bg-stone-900/50">
                        <th class="px-6 py-4 text-xs font-bold text-stone-500 dark:text-stone-400 uppercase tracking-widest border-b border-stone-100 dark:border-stone-700/50">Tanggal Produksi</th>
                        ...
                        <th class="px-6 py-4 text-xs font-bold text-rose-500 uppercase tracking-widest border-b border-stone-100 dark:border-stone-700/50 text-right">Jumlah Rusak (Waste)</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-stone-50 dark:divide-stone-700/30">
                    ...
                    <tr class="hover:bg-rose-50/30 dark:hover:bg-rose-900/10 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <span class="inline-flex items-center gap-1.5 text-sm font-black text-rose-600 dark:text-rose-400">
